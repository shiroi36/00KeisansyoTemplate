...
println("補剛対象の梁: H-800x400x19x28(SM490A)")
...
a = 2 * 28 * 400 + 19 * (800 - 2 * 28) # mm2
@printf("	断面積		A = %.0fmm2\n", a)

c = sigma_y * a / 2 # N
@printf("	圧縮側合力	C = F・A/2 = %.1fkN\n", c / 1e3)

iyy = 2 * 28 * 400^3 / 12 + (800 - 2 * 28) * 19^3 / 12
...
println("補剛材: 2L-75x75x9(2-M16, S10T)")
